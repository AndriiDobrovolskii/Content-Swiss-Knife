...
/** Thinking depth now lives in the settings menu, not in a per-call argument — see
 *  ThinkingLevel in src/prompt-core/model-catalog.ts and ModelSettingsService. */
