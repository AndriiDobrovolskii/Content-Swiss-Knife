...
const TRANSLATIONS = {
  en: {
    ...
    normalizeBtn: 'Normalize to table',
    malformedTableWarning: 'Unclosed table row (missing "|") on line:',
  ...
  uk: {
    ...
    normalizeBtn: 'Нормалізувати в таблицю',
    malformedTableWarning: 'Рядок таблиці незакритий (немає "|") у рядку:',
